...
namespace Liquidinster
{
	partial class MainForm2
	{
		...
		private void InitializeComponent()
		{
			...
			// button7
			// 
			this.button7.Location = new System.Drawing.Point(187, 117);
			...
			// label2
			// 
			this.label2.Location = new System.Drawing.Point(119, 287);
			this.label2.Name = "label2";
			this.label2.Size = new System.Drawing.Size(155, 24);
			this.label2.TabIndex = 214;
			this.label2.Text = "REG-114";
			// 
			// dataGridView1
			// 
			...
			this.label4.Text = "REG-114 visszanéz";
			// 
			// button2
			// 
			...
			this.label3.Text = "REG-114 felvétel";
			// 
			// button3
			// 
			this.button3.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("button3.BackgroundImage")));
			this.button3.Location = new System.Drawing.Point(187, 146);
			...
			// textBox2
			// 
			this.textBox2.Location = new System.Drawing.Point(119, 502);
			...
			this.label7.Text = "REG-116 visszanéz";
			// 
			// button6
			// 
			...
			this.label8.Text = "REG-116 felvétel";
			// 
			// button8
			// 
