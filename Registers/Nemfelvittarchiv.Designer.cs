...
{
	partial class Nemfelvittarchiv
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.label7.Text = "Handover Pepsico archív";
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(221, 30);
			...
			this.dataGridView2.Size = new System.Drawing.Size(860, 644);
			...
			this.Name = "Nemfelvittarchiv";
			this.Text = "Nemfelvittarchiv";
